...
const About = () => {
	return (
		<Container text style={{ marginTop: '2em' }}>
			...
			<p>Fuel icons were created by Georgiana Ionescu and Oksana Latysheva at <a href="https://thenounproject.com/">the Noun Project</a>. Other power symbols are from <a href='https://josm.openstreetmap.de/'>JOSM</a>.</p>
